...
fun FeedingFormScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            ElevatedCard(modifier = Modifier.fillMaxWidth()) {
                Row(modifier = Modifier.fillMaxWidth().clickable { showDatePicker = true }.padding(16.dp), verticalAlignment = Alignment.CenterVertically) {
                    ...
                    Column(Modifier.weight(1f)) {
                        Text("Data dokarmiania", style = MaterialTheme.typography.labelMedium, color = MaterialTheme.colorScheme.onSurfaceVariant)
            ...
            OutlinedTextField(value = uiState.foodType, onValueChange = viewModel::onFoodTypeChange, label = { Text("Rodzaj pokarmu") }, singleLine = true, modifier = Modifier.fillMaxWidth())
